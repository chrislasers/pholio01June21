...
class NewSelectImagesVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UploadImagesPresenterDelegate   {
    ...
    private var uploadPresenter: NewUploadPresenter!
    ...
    override func viewDidLoad() {
        ...
        uploadPresenter = NewUploadPresenter(viewController: self)
